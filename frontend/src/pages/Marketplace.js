...
const PRODUCT_TYPE_OPTIONS = [
  ...
  { value: 'sport', label: 'Vêtements de sport', image: 'https://images.unsplash.com/photo-1556906781-9a412961c28c?w=300&h=300&fit=crop&q=80' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 mt-8 sm:mt-10" data-testid="category-section">
        ...
        >
          ...
          {/* Trouver un professionnel — navigates away from Makiti */}
          <button
            onClick={() => navigate('/browse')}
            className="flex flex-col items-center gap-2 shrink-0 group"
            data-testid="category-find-pro"
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-gray-200 group-hover:border-green-400 transition-all relative">
