...
import { 
  ...
  Key, ShoppingBag, Briefcase, Search, Building2
} from 'lucide-react';
...
const LandingPage = ({ isCustomerAuthenticated }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Qui êtes-vous ? — 3 user personas */}
      <section className="py-12 md:py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Rejoignez ServisPro</h2>
            <p className="text-gray-600 text-sm sm:text-base">Choisissez le profil qui vous correspond pour commencer</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {/* Card 1 — Client */}
            <button
              onClick={() => navigate('/customer/auth?mode=register')}
              data-testid="persona-card-client"
              className="group relative text-left p-6 md:p-7 rounded-2xl border-2 border-green-100 bg-white hover:border-green-500 hover:shadow-xl hover:-translate-y-1 transition-all"
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center mb-4 shadow-lg shadow-green-500/30">
                <User className="h-7 w-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Je suis client</h3>
              <p className="text-sm text-gray-600 mb-4">
                Je recherche un professionnel fiable pour résoudre mes besoins du quotidien.
              </p>
              <span className="inline-flex items-center gap-1 text-green-600 font-semibold text-sm group-hover:gap-2 transition-all">
                Créer mon compte client <ArrowRight className="h-4 w-4" />
              </span>
            </button>

            {/* Card 2 — Prestataire (featured) */}
            <button
              onClick={() => navigate('/auth?mode=register')}
              data-testid="persona-card-provider"
              className="group relative text-left p-6 md:p-7 rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-50 to-amber-50 hover:border-orange-500 hover:shadow-xl hover:-translate-y-1 transition-all overflow-hidden"
            >
              <span className="absolute top-3 right-3 px-2.5 py-0.5 rounded-full bg-orange-500 text-white text-[10px] font-bold uppercase tracking-wide shadow-sm">
                Populaire
              </span>
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center mb-4 shadow-lg shadow-orange-500/30">
                <Briefcase className="h-7 w-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Je suis prestataire</h3>
              <p className="text-sm text-gray-600 mb-4">
                Je propose mes services (plombier, électricien, mécanicien, ...) et je veux développer ma clientèle.
              </p>
            ...
            <button
              ...
              data-testid="persona-card-company"
              className="group relative text-left p-6 md:p-7 rounded-2xl border-2 border-blue-100 bg-white hover:border-blue-500 hover:shadow-xl hover:-translate-y-1 transition-all"
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Je suis une entreprise</h3>
              <p className="text-sm text-gray-600 mb-4">
                J'enregistre mon entreprise pour publier des services, des offres d'emploi ou créer ma boutique.
              </p>
